...
const config = {
  title: '大数据学习笔记',
  tagline: '大数据学习,Big Data Learning',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://bigdata.bookhub.tech',
  ...
  projectName: 'bigdata-learn', // Usually your repo name.
  ...
  scripts: [
    ...
    {
      src: 'https://hm.baidu.com/hm.js?b3e6732167c6ffd7c1eaad3c5f842617',
      async: true
    }
  ],
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [{ name: 'keywords', content: '大数据,bigdata,hive,hadoop,spark,stom,flink,hbase,kafka,zookeeper,flume,sqoop,azkaban,scala' }],
      navbar: {
        title: '大数据学习笔记',
        logo: {
          alt: 'Logo',
        ...
        items: [
          ...
          {
            href: 'https://github.com/dev2007/bigdata-learn',
            position: 'right',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: '魔兽世界服务端',
                href: 'https://azeroth.bookhub.tech/',
              }
            ],
          },
        ],
